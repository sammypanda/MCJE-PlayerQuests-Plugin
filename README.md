...
| UpdateScreenDynamic        | 1: one of the predefined dynamic screens (options: "myquests", "queststages")<br>2: screen to go back to (usually just the current one) | Changes the current GUI screen to present dynamic content |
